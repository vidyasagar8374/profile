...
<?php include 'header.php'; ?>
	...
	<section class="home_banner_area">
		<div class="banner_inner">
			<div class="container">
			<div class="row d-flex align-items-center justify-content-center flex-lg-row flex-md-row flex-sm-row flex-column">
				<div class="col-lg-7 col-md-7 col-sm-12">
					<div class="banner_content text-center text-lg-left">
					<h3 class="text-uppercase">Hello</h3>
					<h1 class="text-uppercase">I am Vidya Sagar</h1>
					<h5 class="text-uppercase">A Full Stack Developer</h5>
				...
				<div class="col-lg-5 col-md-5 col-sm-12 text-center">
					...
					<img src="img/banner/undraw_programming_re_kg9v.svg" alt="">
					</div>
				</div>
				</div>
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						<h2>let’s <br>
							...
							myself</h2>
						<p>
						I design and develop web applications that drive business results, with a focus on seamless user experiences and robust backend systems.
						</p>
						<p>
						With expertise in UI design, backend development, payment solutions, SEO optimization and hosting, I can help you build a web application that meets your goals and objectives
						</p>
				...
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
					 <h1><i class="bi bi-palette"></i> </h1> 
						<h5>UI Design</h5>
						<p>Create visually appealing and user-friendly interfaces using HTML,React, CSS, JavaScript</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
					<h1><i class="bi bi-code"></i></h1>
						...
						<p>Build robust and scalable backend systems using programming languages like PHP,Frame work like Laravel</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
					<h1><i class="bi bi-credit-card"></i></h1>
						...
						<p>Integrate secure payment gateways like Razorpay, PhonePe, Paytm,Stripe, and implement payment processing systems for e-commerce applications.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
					<h1><i class="bi bi-wordpress"></i></h1> 
					<h5>WordPress Expertise</h5> 
						<p> Design, develop, and optimize WordPress websites, themes, and plugins, with expertise in WordPress security, performance, and SEO.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
		...
		<div class="container my-5 section_gap_bottom">
			...
			<div class="row justify-content-center">
				<div class="col-6 col-md-2">
					<div class="custom-card tools-grid p-3">
						<img src="./img/brands/boostrap-svdev.png" class="card-img-top" alt="Image 1">
					</div>
				</div>
				<div class="col-6 col-md-2">
					<div class="custom-card tools-grid p-3">
						<img src="./img/brands/laravel-svdev-.png" class="card-img-top" alt="Image 2">
					</div>
				</div>
				<div class="col-6 col-md-2">
					<div class="custom-card tools-grid p-3">
						<img src="./img/brands/js-svdev.png" class="card-img-top" alt="Image 3">
					</div>
				</div>
				<div class="col-6 col-md-2">
					<div class="custom-card tools-grid p-3">
						<img src="./img/brands/react-svdev.png" class="card-img-top" alt="Image 4">
					</div>
				</div>
			</div>
		</div>
